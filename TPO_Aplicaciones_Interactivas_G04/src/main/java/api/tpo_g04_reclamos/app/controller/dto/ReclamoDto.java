...
public class ReclamoDto {
    ...
    public ReclamoDto(int numero, List<String> imagenesIds, String descripcion, String motivo, EstadoReclamo estado, Long usuarioId, Long unidadId, Long areaComunId) {
        this.numero = numero;
